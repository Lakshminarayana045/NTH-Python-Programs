...
class sims:
    def __init__(self,root):
        ...
        title1=Label(text='Lucky Market',
                     font=('Cooper Black',30),
                     bg='blue',fg='white',bd=5,relief=GROOVE)
        title1.pack(fill='x')
        ...
        #Title of App
        title = Label(self.root,text = "Lucky Billing Software",bd = 12,relief = GROOVE,fg = fg_color,bg = bg_color,font=("times new roman",30,"bold"),pady = 3).pack(fill = X)
        ...
        bill_title = Label(F3,text = "Lucky Bill Area",font = ("Lucida",13,"bold"),bd= 7,relief = GROOVE)
